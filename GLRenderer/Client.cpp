...
void initRigid()
{
    ...
    GBody.setRotation(Vector3(0.0f, 0.0f, 4.0f));
    GBody.setVelocity(Vector3(2.0f, -2.0f, 0.0f));
...
int __stdcall WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR hCmdLine, INT nCmdShow)
{
    glutInit(&nCmdShow, &hCmdLine);
